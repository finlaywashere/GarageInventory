...
function get_invoice($invoice_id){
	...
	$row = $result->fetch_assoc();
	$return = array("notes" => $row['invoice_notes'], "original_id" => $row['original_id'], "type" => $row['invoice_type'], "date" => $row['invoice_date'], "total" => $row['invoice_total'], "subtotal" => $row['invoice_subtotal'], "customer" => $row['customer_id'], "invoice_id" => $row['invoice_id'], "related" => $row['invoice_related'], "due_date" => $row['invoice_due']);
...
function get_invoice_entry($entry_id){
	...
	$row = $result->fetch_assoc();
	$return = array("invoice" => $row['invoice_id'], "product" => $row['product_id'], "original_id" => $row['original_id'], "unit_count" => $row['unit_count'],"count" => $row['entry_count'],"unit_price" => $row['entry_unit_price'],"notes" => $row['entry_notes'], "unit_discount" => $row['entry_discount'], "due" => $row['due_count']);
